...
import { addSelectedStaff, removeStaff } from '../../../stores/slices/selectedStaffSlice';
...
export default function SelectStaff({ staffCode }: SelectStaffProps) {
    ...
    const selectedStaffs = useSelector((state: RootState) => state.selectedStaff.selectedStaff);
                ...
                <input
                    ...
                    onClick={() => {
                        ...
                        if (checked) {
                            ...
                            dispatch(removeStaff(staffCode));
                        } else {
